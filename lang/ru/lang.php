        ...
        'fields' => [
            ...
            'blog' => [
                'post' => [
                    ...
                    'pattern_exclude_variables' => 'Исключить переменные',
                    'pattern_exclude_variable_comment' => 'Переменные которые нужно исключить паттерна URL для постов (пр: pageNumber)',
                    'exclude_variable_prompt' => 'Добавить переменную',
                    'exclude_variable_label' => 'Переменная',
                    'extra_urls' => 'Дополнительнык Url-ы',
                    'extra_urls_comment' => 'Url-ы которые нужно очистить после сохранения поста. Можете использовать переменную слага названую выше как тут: "/:slug". Для рекурсивной очистки добавте "*" в конце (пр: /blog/* , при этом url /blog не очистится, нужно добавить оба варианта отдельно)',
                ...
                'category' => [
                    ...
                    'pattern_exclude_variables' => 'Исключить переменные',
                    'pattern_exclude_variable_comment' => 'Переменные которые нужно исключить паттерна URL для категорий (пр: pageNumber)',
                    'exclude_variable_prompt' => 'Добавить переменную',
                    'exclude_variable_label' => 'Переменная',
                    'extra_urls' => 'Дополнительные Urls',
                    'extra_urls_comment' => 'Url-ы которые нужно очистить после сохранения категории. Можете использовать переменную слага названую выше как тут: "/:slug". Для рекурсивной очистки добавте "*" в конце (пр: /blog/* , при этом url /blog не очистится, нужно добавить оба варианта отдельно)',
                    'extra_urls_prompt' => 'Добавить URL',
                    'extra_urls_label' => 'Url',
                ]
            ]
