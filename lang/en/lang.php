        ...
        'fields' => [
            ...
            'blog' => [
                'post' => [
                    ...
                    'pattern_exclude_variables' => 'Exclude variables',
                    'pattern_exclude_variable_comment' => 'Variables which should be removed from post url pattern (ex: pageNumber)',
                    'exclude_variable_prompt' => 'Add variable',
                    'exclude_variable_label' => 'Variable',
                ...
                'category' => [
                    ...
                    'pattern_exclude_variables' => 'Exclude variables',
                    'pattern_exclude_variable_comment' => 'Variables which should be removed from category URL pattern (ex: pageNumber)',
                    'exclude_variable_prompt' => 'Add variable',
                    'exclude_variable_label' => 'Variable',
                    'extra_urls' => 'Extra Urls',
